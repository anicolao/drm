...
## Block Stack runs from a seeded immutable command journal

![Block Stack runs from a seeded immutable command journal](./screenshots/000-tetris-playing.png)

**Verifications:**
- [x] The 10 by 20 play matrix is visible
