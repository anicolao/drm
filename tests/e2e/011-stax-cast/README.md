...
![The TV reconstructs the Stax wave and owns shared-display piano audio](./screenshots/000-stax-cast.png)
...
- [x] The shared display names the controller player and shows completed waves
