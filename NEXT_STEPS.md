...
- Deterministic next-pill previews are shown above every controller and shared-display bottle without advancing the authoritative RNG. Rain pieces land above the highest occupied cell in their selected columns and top out when no cell remains above it.
