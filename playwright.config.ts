...
export default defineConfig({
  ...
  webServer: {
    ...
    env: { VITE_FIREBASE_API_KEY:'e2e-api-key',VITE_FIREBASE_AUTH_DOMAIN:'drm-e2e.firebaseapp.com',VITE_FIREBASE_DATABASE_URL:'http://127.0.0.1:9000?ns=drm-e2e',VITE_FIREBASE_PROJECT_ID:'drm-e2e',VITE_FIREBASE_APP_ID:'1:123:web:e2e',VITE_USE_FIREBASE_EMULATORS:'true',VITE_E2E_ROOM_CODE:'TEST' }
  },
