...
<div class:compact class="tetris-shell">
  ...
  <div class="matrix" role="img" aria-label={label} data-lines={state.lines} data-score={state.score} data-level={state.level} data-phase={state.phase} data-active-row={state.active?.row} data-active-id={state.active?.id} data-ghost-row={ghostRow(state)}>
