<script lang="ts">
  ...
  import reset from '../../../audio/generated/Prismatic Descent Reset.mp3?url';
  export let enabled=false;
  export let phase:'playing'|'cleared'='playing';
  export let cascadeSignal=0;
  export let resetSignal=0;
  let observed:'playing'|'cleared'=phase,observedCascade=cascadeSignal,observedReset=resetSignal,cueSignal=0,cueUrl=clear;
  ...
  $: if(resetSignal>observedReset){cueUrl=reset;cueSignal++;observedReset=resetSignal}
