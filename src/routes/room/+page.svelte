<script lang="ts">
  ...
  async function playAndCast() {
    window.open(`${base}/cast?code=${code}`, '_blank', 'noopener');
    await startGame('play');
  }
