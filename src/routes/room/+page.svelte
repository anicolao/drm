<script lang="ts">
  ...
  let code = ''; let ruleset: 'tetris' | 'doctor' | 'quarry' | 'canopy' = 'tetris'; let players: RoomPlayer[] = [];
  ...
  async function choose(next: 'tetris' | 'doctor' | 'quarry' | 'canopy') {
